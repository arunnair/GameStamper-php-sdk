...
/**
 * GameStamper PHP SDK that replicates functionality of Facebook PHP SDK
 *
 * All FB endpoints have been replaced w/ their equivalent gamestamper endpoints
 *
 * Built on the work of Naitik Shah <naitik@facebook.com> and Scott MacVicar https://github.com/scottmac
 */
...
class Facebook
{
	...
	public $DOMAIN_MAP = array(
		'api'      => 'https://api.gamestamper.com/',
		'api_read' => 'https://api-read.gamestamper.com/',
	 ...
	 *
	 * @param unknown $method String the method name.
	 ...
	 *
	 * @param unknown $name   String the name of the domain
	 * @param unknown $path   String optional path (without a leading slash)
	 * @param unknown $params Array optional query parameters
	 * @return String the URL for the given parameters
	 */
